      subroutine dforw_ibz ( nk1,nk2,nk3, nbnd, nksfit, etk, eqk, at, vk )
...
!$    use omp_lib
      ...
      !$omp shared(nbnd,nk1,nk2,nk3,vk,etk,eqk)
      do ibnd=1,nbnd
         do i=1,nk1
            do j=1,nk2
               do k=1,nk3
                  ...
                  vk(ibnd,n,1) = ( etk(ibnd,eqk(np))-etk(ibnd,eqk(n)) )/(2.0/nk1)
                  !vk(ibnd,eqk(n),1) = ( etk(ibnd,eqk(np))-etk(ibnd,eqk(nm)) )/(2.0/nk1)
                  !
                  ! velocity along k2
                  !
                  if ( j .eq. 1 ) then
                  ...
                  vk(ibnd,n,2) = ( etk(ibnd,eqk(np))-etk(ibnd,eqk(n)) )/(2.0/nk2)
                  !vk(ibnd,eqk(n),2) = ( etk(ibnd,eqk(np))-etk(ibnd,eqk(nm)) )/(2.0/nk2)
                  !
                  ! velocity along k3
                  !
                  if ( k .eq. 1 ) then
                  ...
                  vk(ibnd,n,3) = ( etk(ibnd,eqk(np))-etk(ibnd,eqk(n)) )/(2.0/nk3)
                  !vk(ibnd,eqk(n),3) = ( etk(ibnd,eqk(np))-etk(ibnd,eqk(nm)) )/(2.0/nk3)
                  !
               end do  ! k
            end do ! j
         end do ! i
